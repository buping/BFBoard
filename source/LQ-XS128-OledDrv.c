...
0x08,0xE8,0xFF,0x48,0x80,0x08,0xC8,0x49,0x4E,0x48,0xC8,0x08,0x08,0x08,
0x03,0x00,0xFF,0x00,0x40,0x30,0x0F,0x00,0x00,0x00,0x3F,0x40,0x40,0x78,
...
/*--  文字:  贝  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
0x00,0x00,0xFE,0x02,0x02,0x02,0xF2,0x02,0x02,0x02,0xFE,0x00,0x00,0x00,
0x40,0x40,0x27,0x20,0x10,0x08,0x07,0x08,0x10,0x10,0x27,0x60,0x00,0x00,

/*--  文字:  分  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
0x40,0x20,0x98,0x87,0x82,0x80,0x80,0x83,0x84,0x98,0x30,0x60,0xC0,0x40,
0x80,0x40,0x20,0x10,0x0F,0x00,0x00,0x20,0x40,0x3F,0x00,0x00,0x00,0x00,
/*--  文字:  电  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
...
/*--  文字:  有  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
0x04,0x84,0x44,0xE4,0x34,0x2C,0x27,0x24,0x24,0x24,0xE4,0x04,0x04,0x04,
0x01,0x00,0x00,0xFF,0x09,0x09,0x09,0x29,0x49,0xC9,0x7F,0x00,0x00,0x00,

/*--  文字:  限  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
0xFE,0x02,0x32,0x4E,0x82,0x00,0xFE,0x4A,0xCA,0x4A,0x4A,0x4A,0x7E,0x00,
0xFF,0x00,0x02,0x04,0x03,0x00,0xFF,0x40,0x20,0x03,0x0C,0x12,0x21,0x60,
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
0x00,0x80,0x40,0x30,0x0E,0x84,0x00,0x00,0x0E,0x10,0x60,0xC0,0x80,0x80,
0x01,0x20,0x70,0x28,0x24,0x23,0x31,0x10,0x10,0x14,0x78,0x30,0x01,0x00,

/*--  文字:  司  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
0x10,0x92,0x92,0x92,0x92,0x92,0x92,0x92,0x92,0x12,0x02,0x02,0xFE,0x00,
0x00,0x1F,0x04,0x04,0x04,0x04,0x04,0x04,0x0F,0x00,0x20,0x40,0x3F,0x00,
};
...
void LcdMain(void)
{
	 ...
	 INT8U data = 0,i;
      ...
      LCD_Print(23,0,"杭州贝分科技");
      if(gDeviceType == DEVICE_CAR)
      {
          LCD_Print(0,2,"Car ");
      }
	  else  if(gDeviceType == DEVICE_ENTRY)
      {
          LCD_Print(0,2,"Entry ");
      }
	  ...
	  else  if(gDeviceType == DEVICE_WASTER)
      {
          LCD_Print(0,2,"Waster ");
      }
      else
      {
          LCD_Print(0,2,"Error!!!"); 
      }
      int16HexToBCD(gSwitch,str);
      LCD_Print(0,4,"ID:");
	...
	//LCD_Print(0,4,"                              ");
      if(gDeviceType == DEVICE_CAR)
      {
		  ...
		  {
		  	 LCD_Print(70,6,"Error");
		  }

		  LCD_Print(99,6,"D:");
		  if(gCar.direction == SUCCEED)
		  {
		     LCD_Print(115,6,"P");
		  }
		  else
	 ...
	 //LCD_Print(2,3,"电子杭州");
      //LCD_P8x16Str(48,4,"科技有限公司");
	  //LCD_Print(2,2,"激光编码盒");
      /*
      data = 0x32;
      LCD_P6x8Str(0,6,(char*)&data); 
      data++;
      LCD_P6x8Str(6,6,(char*)&data); 
      data++;
      LCD_P6x8Str(12,6,(char*)&data);
      //*/
